        ...
        <div class="box">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input">
                    ...
                    <input type="text" id="name" class="block mt-1 w-full @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required  autofocus autocomplete="name">
                    @error('name') <span class="text-danger mt-3">{{ $message }}</span>@enderror
                </div>
                <div class="input">
                    <label for="emailname">{{ __('Email Address') }}</label>
